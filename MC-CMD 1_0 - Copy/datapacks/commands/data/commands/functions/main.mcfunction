...
#Program UI
function commands:programui/summon
effect give @e[tag=UI] minecraft:invisibility 1 255 true
execute as @a at @s run function commands:programui/managevisuals